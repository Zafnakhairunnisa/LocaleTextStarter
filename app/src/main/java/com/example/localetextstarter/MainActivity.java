...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView experiedTextView = findViewById(R.id.date);
        experiedTextView.setText(formatDate);

        priceItem = findViewById(R.id.price_et);
        priceConv = findViewById(R.id.result_price);
        ...
        btnPrice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String formatResult = numberFormat.format(result);

                priceConv.setText(formatResult);
